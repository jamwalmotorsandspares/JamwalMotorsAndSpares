                ...
                <div class="col-xxl-12 col-xl-12">
                    <div class="card">
                        <div class="card-header pb-0">
                            <h4 class="card-title">@lang('site.create') @lang('site.orders')</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="form-row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="single-select @error('client') is-invalid @enderror"
                                                name="client">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('payment_method') is-invalid @enderror"
                                                name="payment_method">
                                                <option value="0">@lang('site.cash')</option>
                                                <option value="1">@lang('site.online')</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
